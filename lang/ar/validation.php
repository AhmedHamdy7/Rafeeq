...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'قيمة :attribute المُدخلة ظهرت في تسريب بيانات سابق. الرجاء اختيار :attribute آخر.',
    ],
    ...
    */
    ...
    'custom' => [
        ...
        'date_of_birth' => [
            'minimum_age' => 'لازم يكون عمرك :age سنة على الأقل لاستخدام رفيق.',
        ],
        'full_name' => [
            'format' => 'اكتب اسمك بحروف عربية أو إنجليزية فقط.',
        ],
    ],
